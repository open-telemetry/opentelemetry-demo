...
4. Configure:
   ...
   - **commit_manifest**: ☐ Unchecked (usually)
...
4. Configure:
   ...
   - **commit_manifest**: ☑ Checked (usually)
   - **validate_manifest**: ☑ Checked
...
|-----------|-------------|---------|
| **patch** | Bug fixes, minor updates | `0.0.0` → `0.0.1` |
| **minor** | New features, backwards compatible | `0.0.0` → `0.1.0` |

...
- [grafana] Update Faro to v1.4.0 and remove the experimental performance-timeline instrumentation
  ([#1425](https://github.com/open-telemetry/opentelemetry-demo/pull/1425))

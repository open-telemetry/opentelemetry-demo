...
generate-kubernetes-manifests:
	@mkdir -p kubernetes
	@echo "Adding OpenTelemetry Helm Charts repository and generating Kubernetes manifests for OpenTelemetry Demo..."
	@echo " "
	...
	@echo " "
	@echo "Generated Kubernetes manifests have been written to kubernetes/opentelemetry-demo.yaml"

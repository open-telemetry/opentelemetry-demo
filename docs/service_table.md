...
| [frontend](../src/frontend/README.md)                           | JavaScript/TypeScript              | Exposes an HTTP server to serve the website. Does not require signup/login and generates session IDs for all users automatically.            |

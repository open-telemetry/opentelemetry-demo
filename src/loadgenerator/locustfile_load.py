...
class WebsiteUser(HttpUser):
    ...
    def add_to_cart(self, user=""):
        ...
        self.client.post("/api/cart", json=cart_item,headers={"Host: "+ HOST})
    ...
    def checkout(self):
        ...
        self.client.post("/api/checkout", json=checkout_person,headers={"Host: "+ HOST})
...
class StagesShape(LoadTestShape):
    ...
    stages = [
        ...
        {"duration": 600, "users": 350, "spawn_rate": 10},
        {"duration": 600, "users": 400, "spawn_rate": 10},
        {"duration": 600, "users": 450, "spawn_rate": 10},
    ]
